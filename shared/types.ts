...
export function defaultSleeves(): Record<SleeveId, SleeveCard> {
  return {
    ...
    riskoff: {
      ...
      killRules: "max debit lost / DTE / sleeve loss cap; ETF rotates on RS/hysteresis/CTA-diversifier change; gated duration exits on SPY/dollar/RISK ON",
      status: "paper",
      paper: emptyPaperStats(),
      updatedAt: null,
    },
