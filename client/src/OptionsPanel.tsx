        ...
        {putsOnly && (
          <>
            ...
            <div className="hint">
              ...
              (DBMF/KMLM), #2 is a non-CTA name when one clears (GDX, CLSE, USMV, or FTLS can fill that slot); otherwise #2 is BIL. Never KMLM+DBMF. If #1 is gold (GLD/GDX), #2 is a non-gold name when one clears; otherwise #2 is BIL. Never GLD+GDX. Re-rank only at the NY cash close, and do not RS-rotate a name off until it has been held 5 trading sessions. GDX is equity-levered gold beta, USMV is min-vol equity, and FTLS is long/short equity; none of them is CTA, so a weak 21-session return does not skip them. Flattened on RISK ON. Modest size so puts still have
              room.
            </div>
            <table>
              <thead>
