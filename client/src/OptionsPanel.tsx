      ...
      <div className="body">
        ...
        {putsOnly && (
          <>
            ...
            <div className="hint">
              Autopilot holds the one or two names among GLD, GDX, PDBC, UUP, TLT, IEF, XLU, XLP, DBMF, KMLM, CLSE, USMV, QUAL, FTLS, and BTAL that
              ...
              (DBMF/KMLM), #2 is a non-CTA name other than PDBC when one clears (GDX, CLSE, USMV, QUAL, FTLS, or BTAL can fill that slot); otherwise #2 is BIL. Never KMLM+DBMF. Never PDBC+DBMF or PDBC+KMLM. If #1 is PDBC, #2 is a non-CTA name when one clears; otherwise #2 is BIL. If #1 is gold (GLD/GDX), #2 is a non-gold name when one clears; otherwise #2 is BIL. Never GLD+GDX. Re-rank only at the NY cash close, and do not RS-rotate a name off until it has been held 5 trading sessions. GDX is equity-levered gold beta, USMV is min-vol equity, QUAL is quality-factor equity, FTLS is long/short equity, and BTAL is market-neutral anti-beta; none of them is CTA, so a weak 21-session return does not skip them. Flattened on RISK ON. Modest size so puts still have
              room.
            </div>
            <table>
              <thead>
